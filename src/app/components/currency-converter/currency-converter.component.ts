...
export class CurrencyconComponent implements OnInit {
  data:any;
...
  convert() {
    this.currencyConversion.get(this.toCurrency, this.fromCurrency).subscribe((ret: any)=>{
      console.log(ret);
      const exchangeRate = ret['Realtime Currency Exchange Rate']['5. Exchange Rate'];
